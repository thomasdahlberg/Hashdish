...
class EditMenuItem extends Component {
    ...
    handleOptionChange = (e) => {
        switch(e.target.name) {
            case 'title':
                console.log('Title!')
                this.changeOptionTitle(e);
                break;
            case 'forward':
                console.log('Forward!')
                this.moveOptionForward(e);
                break;
            case 'backward':
                console.log('Backward!')
                this.moveOptionBackward(e);
                break;
            case 'delete':
                console.log('Delete!')
                this.deleteOption(e);
            ...
            case 'add':
                ...
                break;
            default:
                console.log(`Option Change Error: ${e}`);
                break;
        }
    }

    deleteOption = (optionObj) => {
        // optionObj[idx].options.splice(idx2, 1)
    }
